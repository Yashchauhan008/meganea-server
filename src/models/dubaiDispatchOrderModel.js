// backend/models/dubaiDispatchOrderModel.js

import mongoose from 'mongoose';

const dubaiDispatchOrderSchema = new mongoose.Schema({
  // The human-readable ID for this dispatch (e.g., DDO-00001)
  dispatchNumber: { 
    type: String, 
    required: true, 
    unique: true 
...
dubaiDispatchOrderSchema.statics.archive = async function (id) {
